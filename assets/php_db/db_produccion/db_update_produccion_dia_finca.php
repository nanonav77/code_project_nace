<?php
    ...
    $sql = "UPDATE nace_produccion_fincas set cajuelas='$cajuelas_ingresadas', cuartillos='$cuartillos_ingresados' 
    where fecha='$fecha_ingresada' and id_finca='$id_finca_ingresado'
