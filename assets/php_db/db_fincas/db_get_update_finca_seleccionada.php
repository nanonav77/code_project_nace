<?php
    ...
    $consulta = "SELECT a.ide as numero_finca, a.nombre as nombre_finca, a.direccion as direccion_finca, b.nombre as nombre_propietario,b.apellidos as apellidos_propietario,b.identificacion as identificacion_propietario, b.ide as ide_propietario FROM nace_fincas as a join nace_usuarios as b on a.ide_propietario = b.ide WHERE a.ide = '$numero_ingresado'";
   ...
   if ($conexion)
   {
       while($row = mysqli_fetch_array($resultado)){
          ...
          $row_array['ide_propietario'] = $row['ide_propietario'];
